...
read -p "TOKEN ربات را وارد کنید: " BOT_TOKEN
...
# === ساخت فایل ربات ===
echo "ساخت فایل bot_auto_username.py ..."
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("سلام! یک یوزرنیم با @ بفرست تا آیدی عددی را ارسال کنم.")
